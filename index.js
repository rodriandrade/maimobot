...
app.action("arteydiseño_button", async ({ ack, say, body, action}) => {
  ...
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Arte y diseño :art::white_check_mark:`);
...
app.action("cine_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Cine :movie_camera::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("literatura_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Literatura :books::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("memes_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Memes :laughing::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("oportunidadeslaborales_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Oportunidades Laborales :mailbox_with_mail::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("musiquita_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Musiquita :musical_note::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("plantitas_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Plantitas y Naturaleza :seedling::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("procrastinacionyanimalitos_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Procrastinación y Animalitos :hatched_chick::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("programacion_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Programación :computer::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("recetas_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Recetas :knife_fork_plate::white_check_mark:`);
  inviteToChannel(user, value);
});
...
app.action("sillondelpsicologo_button", async ({ ack, say, body, action}) => {
  ...
  let value = action.value;
  let user = body.user.id;
  await say(`Todo listo, <@${body.user.id}>, ya te sumé al canal de Sillón del Psicólogo :couch_and_lamp::white_check_mark:`);
  inviteToChannel(user, value);
});
